#pragma once
#define HTML_BUNDLE_SIZE 58401
static std::string html_bundle = 
R"4b2a575c(<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    ...
    function Header() {
      return html`<div class="header">
        ...
        <div style="display: flex; gap: 16px">
          <div></div>
          <div>API doc</div>
          <div><a href="https://github.com/extremeheat/stable-diffusion.cpp">GitHub</a></div>
        </div>
      </div>`
    }
