#pragma once
#define HTML_BUNDLE_SIZE 56487
static std::string html_bundle = 
R"2c2ff8d0(<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
R"2c2ff8d0(           title="-1 will create a random seed on each generation"
                  onClick=${() => {
                    setSeed(-1)
                  }}>
                  🎲
    ...
    function App() {
      ...
      // const [modelStatus,)2c2ff8d0" 
R"2c2ff8d0( setModelStatus] = useState({ justStarted: false, ok: true, message: "" })
