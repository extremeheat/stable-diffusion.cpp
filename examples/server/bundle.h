#pragma once
#define HTML_BUNDLE_SIZE 57064
static std::string html_bundle = 
R"417de3e2(<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
            ...
            <div class="group">
              <div>
                ...
                <input
                  type="text"
                  value=${seed}
                  onInput=${(e) => setSeed(e.target.value)417de3e2" 
R"417de3e2()}
    ...
    function App() {
      const [models, setM)417de3e2" 
R"417de3e2(odels] = useState([])
