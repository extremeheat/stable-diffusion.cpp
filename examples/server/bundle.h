#pragma once
#define HTML_BUNDLE_SIZE 57420
static std::string html_bundle = 
R"5dbe9a04(<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
R"5dbe9a04(return Promise.resolve({
          ok: true,
