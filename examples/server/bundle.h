#pragma once
#define HTML_BUNDLE_SIZE 56859
static std::string html_bundle = 
R"a441c20c(<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
            ...
            <div class="group">
              <div>
                ...
                <input
                  type="text"
                  value=${seed}
                  onInput=${(e) => setSeed(e.target.value)a441c20c" 
R"a441c20c()}
    ...
    function App() {
      const [models, setM)a441c20c" 
R"a441c20c(odels] = useState([])
